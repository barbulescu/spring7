...
* [Coroutines section of the Spring Framework Documentation](https://docs.spring.io/spring-framework/reference/7.0.0-RC2/languages/kotlin/coroutines.html)
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/4.0.0-RC1/reference/packaging/native-image/introducing-graalvm-native-images.html)
* [Distributed Tracing Reference Guide](https://docs.micrometer.io/tracing/reference/index.html)
* [Getting Started with Distributed Tracing](https://docs.spring.io/spring-boot/4.0.0-RC1/reference/actuator/tracing.html)
...
* [Spring Reactive Web](https://docs.spring.io/spring-boot/4.0.0-RC1/reference/web/reactive.html)
* [Reactive HTTP Client](https://docs.spring.io/spring-boot/4.0.0-RC1/reference/io/rest-client.html#io.rest-client.webclient)
...
* [Spring Data R2DBC](https://docs.spring.io/spring-boot/4.0.0-RC1/reference/data/sql.html#data.sql.r2dbc)
...
* [OTLP for metrics](https://docs.spring.io/spring-boot/4.0.0-RC1/reference/actuator/metrics.html#actuator.metrics.export.otlp)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/4.0.0-RC1/how-to/aot.html)
...
```
$ docker run --rm spring7:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring7
```
